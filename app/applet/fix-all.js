...
walk(root, (file) => {
  if (file.endsWith('.ts')) {
    ...
    // 1. Remove unused ExportFormat imports
    ...
    // 6. Replace unused params in shared services
    ...
    // 7. Replace PDF selectors (camelCase to kebab-case)
    ...
    // 8. Replace unused ExportFormatSchema
