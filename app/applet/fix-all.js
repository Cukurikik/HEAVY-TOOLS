...
<<<<<<< HEAD
    // Replace unused config in services
    ...
    // Replace unused variables in workers
=======
...
>>>>>>> origin/fix/fix-all-script-comments-3657089364240641425
...
<<<<<<< HEAD
    ...
    // Replace unused params in shared services
=======
    // 4. Resolve any types
    content = content.replace(/\(\{ progress: p \}: any\)/g, '({ progress: p }: { progress: number })');
    content = content.replace(/onFileSelected\(e: any\)/g, 'onFileSelected(e: Event)');
...
<<<<<<< HEAD
    // Replace PDF selectors (camelCase to kebab-case)
=======
...
<<<<<<< HEAD
    // Replace unused ExportFormatSchema
=======
