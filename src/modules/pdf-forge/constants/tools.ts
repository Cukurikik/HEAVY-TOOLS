...
// Optimization: Directly referencing the icon components instead of strings.
// This avoids using a wildcard import `import * as Icons from 'lucide-react'` in the dashboard component,
// which prevents Webpack and Next.js from properly tree-shaking the unused icons out of the client bundle.
