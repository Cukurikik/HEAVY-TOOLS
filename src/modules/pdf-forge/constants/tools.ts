...
// ⚡ Bolt Optimization: Removed dynamic import `import * as Icons` and explicit string mapping.
// 💡 What: Directly importing required Lucide React icons by name and passing the React component reference.
// 🎯 Why: Dynamic property lookups on wildcard imports completely defeat Next.js/Webpack tree-shaking.
// 📊 Impact: Prevents bundling the entire ~160KB lucide-react library into the client bundle, drastically reducing First Load JS size.
