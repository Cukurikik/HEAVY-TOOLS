...
import {
  Scissors, Combine, FileAudio, Sliders, Split, TrendingUp, Clock,
  VolumeX, BarChart3, Gauge, Waves, Activity, Eraser, Mic, Speaker,
  MoveHorizontal, AudioWaveform, Tag, Heart, Key, Layers, Podcast,
  Mic2, BarChart, Sunset, Repeat, Music, Headphones, Circle, ArrowRight
} from "lucide-react";
