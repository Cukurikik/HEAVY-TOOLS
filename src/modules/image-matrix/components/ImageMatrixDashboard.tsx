...
import { Play, CheckCircle, Loader2, Image as ImageIcon } from "lucide-react";
          ...
          >
            ...
            {task.file ? (
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <p className="text-slate-300 font-medium">Drag & drop your image here</p>
        ...
        <button
          ...
          className={cn(
            ...
            !task.file || task.operation === "idle"
              ...
              : "bg-pink-500 hover:bg-pink-400 text-white hover:scale-105 active:scale-95"
          )}
        >
          {task.status === "processing" ? (
            <>
