  ...
  template: `
    ...
    <div class="max-w-7xl mx-auto space-y-8 animate-fade-in-up">
      ...
      <header class="space-y-1">
        <h1 class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 drop-shadow-lg tracking-tight" class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-200">
          🔗 Video Merger
        </h1>
