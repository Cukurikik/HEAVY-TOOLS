...
@Component({
  ...
  template: `
    <app-video-tool-layout
      ...
      description="Replace or mix a new audio track into your video"
          ...
          @if ((state$ | async)?.videoMeta; as meta) {
            <div class="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-4">
              ...
              <div class="space-y-2">
                ...
                <span class="flex items-center gap-3 p-4 rounded-xl border-2 border-dashed border-white/20 hover:border-rose-400/50 bg-white/5 cursor-pointer transition-all" style="display: block;">
              ...
              <button [disabled]="(canProcess$ | async) === false || (isLoading$ | async) || !audioFile" (click)="onProcess()"
