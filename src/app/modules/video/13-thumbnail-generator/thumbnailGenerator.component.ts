  ...
  template: `
    <div class="p-8 glass-panel rounded-2xl max-w-4xl mx-auto">
      <h2 class="text-3xl font-bold mb-4 flex items-center gap-2">
        <mat-icon class="text-accent-cyan">image</mat-icon> Thumbnail Generator
      </h2>
      <p class="text-text-secondary mb-8">Extract high-quality frames or generate custom thumbnails.</p>
      <div class="aspect-video bg-black/40 rounded-xl flex items-center justify-center border border-dashed border-white/20">
        <span class="text-text-muted">Select video to generate thumbnails</span>
      </div>
    </div>
  `
})
