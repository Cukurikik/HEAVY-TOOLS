  ...
  template: `
    <div class="min-h-screen bg-[#0a0a0f] p-6 space-y-6">
      <header class="space-y-1">
        ...
        <p class="text-white/50 text-sm">Apply full-frame blur, region blur (privacy censor), or background blur effect</p>
      </header>
...
export class BlurComponent implements OnDestroy {
  ...
  async onFileSelected(files: File[]) {
    ...
    try {
      ...
      this.store.dispatch(BlurActions.loadMetaFailure({
