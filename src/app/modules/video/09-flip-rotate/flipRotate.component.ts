  ...
  template: `
    <div class="min-h-screen bg-[#0a0a0f] p-6 space-y-6">
      <header class="space-y-1">
        ...
        <p class="text-white/50 text-sm">Flip video horizontally/vertically and rotate by arbitrary degrees</p>
      </header>
...
export class FlipRotateComponent implements OnDestroy {
  ...
  async onFileSelected(files: File[]) {
    ...
    try {
      ...
      this.store.dispatch(FlipRotateActions.loadMetaFailure({
