...
@Component({
  ...
  template: `
    <app-video-tool-layout
      ...
      description="Hardcode SRT/ASS subtitles permanently into the video"
      gradientClass="from-yellow-400 to-amber-400">
          ...
          @if ((state$ | async)?.videoMeta; as meta) {
            <div class="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-4">
              ...
              <div class="space-y-2">
                ...
                <span class="flex items-center gap-3 p-4 rounded-xl border-2 border-dashed border-white/20 hover:border-yellow-400/50 bg-white/5 cursor-pointer transition-all" style="display: block;">
              ...
              <button [disabled]="(canProcess$ | async) === false || (isLoading$ | async) || !subtitleFile" (click)="onProcess()"
