// ============================================================
// VIDEO ERRORS — Error Codes & Resolution
// File: src/app/modules/video/shared/errors/video.errors.ts
// ============================================================

import { VideoErrorCode } from '../types/video.types';
...
const RETRYABLE_CODES = new Set<VideoErrorCode>([
  'FFMPEG_TIMEOUT', 'FFMPEG_OOM', 'WORKER_CRASHED', 'FILE_READ_ERROR', 'WORKER_TRANSFER_FAILED',
]);
...
export function getVideoError(code: VideoErrorCode): {
  ...
  return {
    code,
    message: VideoErrorMessages[code],
