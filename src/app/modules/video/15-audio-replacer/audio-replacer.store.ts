...
export const AudioReplacerActions = {
  ...
  loadAudio: createAction('[AudioReplacer] Load Audio', props<{ file: File }>()),
...
export const audioReplacerFeature = createFeature({
  ...
  reducer: createReducer(init,
    ...
    on(AudioReplacerActions.loadAudio, (s, a) => ({ ...s, audioFile: a.file })),
    ...
    on(AudioReplacerActions.processingFailure, (s, a) => ({ ...s, status: 'error' as const, errorCode: a.errorCode, errorMessage: a.message })),
