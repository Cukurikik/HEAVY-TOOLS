  ...
  template: `
    <div class="p-8 glass-panel rounded-2xl max-w-4xl mx-auto">
      <h2 class="text-3xl font-bold mb-4 flex items-center gap-2">
        <mat-icon class="text-accent-cyan">screen_share</mat-icon> Screen Recorder
      </h2>
      <p class="text-text-secondary mb-8">Record your screen or specific window directly in the browser.</p>
      <div class="aspect-video bg-black/40 rounded-xl flex items-center justify-center border border-dashed border-white/20">
        <span class="text-text-muted">Click to start recording</span>
      </div>
    </div>
  `
})
