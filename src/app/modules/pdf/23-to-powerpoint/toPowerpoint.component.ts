...
export class ToPowerpointComponent implements OnDestroy {
  store = inject(Store);
     ...
     this.state$.subscribe(state => {
        ...
        this.bridge.process<any, Blob>(
          ...
          { file: state.inputFile }
           ...
           next: (msg) => {
              if (msg.type === 'progress') this.store.dispatch(ToPowerpointActions.updateProgress({ progress: msg.value ?? 0 }));
