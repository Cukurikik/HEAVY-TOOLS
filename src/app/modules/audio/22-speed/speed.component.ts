...
import { AudioSpeedState, audioSpeedFeature, audioSpeedActions } from './speed.store';
    ...
    <div class="max-w-7xl mx-auto space-y-8 animate-fade-in-up">
      ...
      <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 drop-shadow-lg tracking-tight" class="text-xl font-bold text-white">Speed Changer</h1>
...
export class AudioSpeedComponent implements OnDestroy {
