      ...
      <div class="max-w-4xl mx-auto space-y-6">
        ...
        @if ((state$ | async)?.inputFile) {
          <div class="bg-[#12121a] rounded-2xl p-6 border border-white/5 space-y-4">
            ...
            <div class="flex gap-2 mb-4"><button class="px-4 py-2 rounded-lg text-sm" [class.bg-cyan-500]="localMethod==='midSide'" (click)="localMethod='midSide'">Mid-Side (Fast)</button><button class="px-4 py-2 rounded-lg text-sm" [class.bg-purple-500]="localMethod==='ai'" (click)="localMethod='ai'">🤖 AI Separation</button></div>
          </div>
