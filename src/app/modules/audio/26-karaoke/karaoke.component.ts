...
import { karaokeFeature, karaokeActions } from "./karaoke.store";
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-white/40">
              Remove or isolate vocals using AI stem separation
            </p>
          </div>
        </div>
          ...
          >
            ...
            <div class="flex gap-2 mb-4">
              <button
                ...
                [class.bg-cyan-500]="localMethod === 'midSide'"
                (click)="localMethod = 'midSide'"
              >
                Mid-Side (Fast)
              </button>
              <button
                class="px-4 py-2 rounded-lg text-sm"
                [class.bg-purple-500]="localMethod === 'ai'"
                (click)="localMethod = 'ai'"
              >
                🤖 AI Separation
              </button>
            </div>
