      ...
      <div class="max-w-4xl mx-auto space-y-6">
        ...
        @if ((state$ | async)?.inputFile) {
          <div class="bg-[#12121a] rounded-2xl p-6 border border-white/5 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">@for(field of ['Title','Artist','Album','Year','Genre'];track field){<app-audio-text-input [label]="field" [placeholder]="field"></app-audio-text-input>}</div>
          </div>
