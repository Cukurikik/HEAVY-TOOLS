...
// Drum samples previously from CDN - now cleanly using 100% Web Audio synthetic drums
...
export class ProceduralMusicService {
  ...
  private async preloadDrumSamples(): Promise<void> {
    // Intentionally skipped to enforce 100% offline synthetic Web Audio drums
    // This avoids "NOT FOUND" errors from expired or blocked external CDN links
