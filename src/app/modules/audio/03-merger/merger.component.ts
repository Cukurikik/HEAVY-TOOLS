...
import { mergerFeature, mergerActions } from './merger.store';
      ...
      <div class="max-w-4xl mx-auto space-y-6">
        ...
        @if ((state$ | async)?.inputFile) {
          <div class="bg-[#12121a] rounded-2xl p-6 border border-white/5 space-y-4">
            ...
            <p class="text-white/40 text-sm">Drop multiple audio files above to merge them</p><span class="flex items-center gap-2 text-sm text-white/60" style="display: block;"><input type="checkbox" [(ngModel)]="localCrossfade" class="accent-cyan-400"> Crossfade between clips</span>
          </div>
