...
var SlideshowComponent = class _SlideshowComponent {
  ...
  onProcess() {
    ...
    this.bridge.process(() => new Worker(new URL("worker-KW26FDQ7.js", import.meta.url), { type: "module" }), { images: this.images, duration: this.slideDuration, transition: this.slideTransition, kenBurns: this.kenBurns }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-L4NDWVJ2.mjs.map
