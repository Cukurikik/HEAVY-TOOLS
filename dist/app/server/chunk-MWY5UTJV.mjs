...
var BatchComponent = class _BatchComponent {
  ...
  onProcess() {
    ...
    this.currentFile = 1;
    this.bridge.process(() => new Worker(new URL("worker-4VJAIH5M.js", import.meta.url), { type: "module" }), { files: this.files, operation: this.operation, crf: this.batchCrf }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-MWY5UTJV.mjs.map
