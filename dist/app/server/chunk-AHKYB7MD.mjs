...
var InterpolatorComponent = class _InterpolatorComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-BBLSHRQP.js", import.meta.url), { type: "module" }), { file: state.inputFile, targetFps: this.targetFps, algorithm: this.algo_mode }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-AHKYB7MD.mjs.map
