...
var SpeedControllerComponent = class _SpeedControllerComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-OOKLNP45.js", import.meta.url), { type: "module" }), { file: state.inputFile, speed: state.speed, audioMode: state.audioMode }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-STK2SF3K.mjs.map
