...
import {
  ...
  ofType,
  provideEffects
} from "./chunk-KH53N6JK.mjs";
import {
  watermarkFeature
} from "./chunk-O5VAL6Q3.mjs";
import {
  audioExtractorFeature
} from "./chunk-HMELKHEI.mjs";
import {
...
import {
  converterFeature
} from "./chunk-22UQO6RC.mjs";
import {
  compressorFeature
} from "./chunk-RUON6OFS.mjs";
import {
  stabilizerFeature
} from "./chunk-U7AWE7LE.mjs";
import {
  reverserFeature
} from "./chunk-3TOMZTRE.mjs";
import {
  looperFeature
} from "./chunk-I7NDQ42H.mjs";
import {
  addTask,
  completeTask,
  failTask,
    ...
    if (c) {
      ...
      if (spec.attributes) {
        for (var n in spec.attributes) {
          ...
          props2[n] = attributes2.property(attr);
        }
      }
      props2.constructor = {
        value: c,
      ...
      c.prototype = Object.create((spec.superclass || defaultConstructor).prototype, props2);
      if (spec.events) {
...
function requireHTMLParser() {
  ...
  function HTMLParser(address, fragmentContext, options) {
    ...
    htmlparser.testTokenizer = function(input2, initialState6, lastStartTag, charbychar) {
      var tokens = [];
...
var ServerXhr = class _ServerXhr {
  ...
  async \u0275loadImpl() {
    if (!this.xhrImpl) {
      const {
        default: xhr
      } = await import("./chunk-6JLMVI5M.mjs");
      this.xhrImpl = xhr;
    }
  }
  build() {
...
var routes = [
  ...
  }, true ? { \u0275entryName: "src/app/layout/shell/shell.component.ts" } : {}),
  { path: "**", redirectTo: "" }
];
...
// src/app/modules/video/07-speed-controller/speed-controller.store.ts
var init = {
  inputFile: null,
  videoMeta: null,
  speed: 1,
...
var SpeedControllerActions = {
  ...
  updateSpeed: createAction("[SpeedController] Update Speed", props()),
...
var speedControllerFeature = createFeature({
  ...
  reducer: createReducer(init, on(SpeedControllerActions.loadFile, (s, a) => __spreadProps(__spreadValues({}, s), { inputFile: a.file, status: "loading", outputBlob: null, errorMessage: null, progress: 0 })), on(SpeedControllerActions.loadMetaSuccess, (s, a) => __spreadProps(__spreadValues({}, s), { videoMeta: a.meta, status: "idle" })), on(SpeedControllerActions.loadMetaFailure, (s, a) => __spreadProps(__spreadValues({}, s), { status: "error", errorCode: a.errorCode, errorMessage: a.message })), on(SpeedControllerActions.updateSpeed, (s, a) => __spreadProps(__spreadValues({}, s), { speed: a.speed })), on(SpeedControllerActions.startProcessing, (s) => __spreadProps(__spreadValues({}, s), { status: "processing", progress: 0, outputBlob: null })), on(SpeedControllerActions.updateProgress, (s, a) => __spreadProps(__spreadValues({}, s), { progress: a.progress })), on(SpeedControllerActions.processingSuccess, (s, a) => __spreadProps(__spreadValues({}, s), { status: "done", progress: 100, outputBlob: a.outputBlob, outputSizeMB: a.outputSizeMB })), on(SpeedControllerActions.processingFailure, (s, a) => __spreadProps(__spreadValues({}, s), { status: "error", errorCode: a.errorCode, errorMessage: a.message })), on(SpeedControllerActions.resetState, () => init))
});
var { selectSpeedControllerState, selectStatus, selectProgress, selectOutputBlob } = speedControllerFeature;

// src/app/modules/video/12-subtitle-burner/subtitle-burner.store.ts
var initialState2 = {
  videoFile: null,
  subtitleFile: null,
  meta: null,
...
var subtitleBurnerActions = {
  loadVideo: createAction("[SubtitleBurner] Load Video", props()),
  loadSubtitle: createAction("[SubtitleBurner] Load Subtitle", props()),
  setMeta: createAction("[SubtitleBurner] Set Meta", props()),
  startProcessing: createAction("[SubtitleBurner] Start Processing"),
  setProgress: createAction("[SubtitleBurner] Set Progress", props()),
  completeProcessing: createAction("[SubtitleBurner] Complete Processing", props()),
  setError: createAction("[SubtitleBurner] Set Error", props()),
  reset: createAction("[SubtitleBurner] Reset")
};
var subtitleBurnerFeature = createFeature({
  name: "subtitleBurner",
  reducer: createReducer(initialState2, on(subtitleBurnerActions.loadVideo, (state, { file }) => __spreadProps(__spreadValues({}, state), { videoFile: file, outputUrl: null, error: null })), on(subtitleBurnerActions.loadSubtitle, (state, { file }) => __spreadProps(__spreadValues({}, state), { subtitleFile: file, outputUrl: null, error: null })), on(subtitleBurnerActions.setMeta, (state, { meta }) => __spreadProps(__spreadValues({}, state), { meta })), on(subtitleBurnerActions.startProcessing, (state) => __spreadProps(__spreadValues({}, state), { isProcessing: true, progress: 0 })), on(subtitleBurnerActions.setProgress, (state, { progress }) => __spreadProps(__spreadValues({}, state), { progress })), on(subtitleBurnerActions.completeProcessing, (state, { outputUrl }) => __spreadProps(__spreadValues({}, state), { isProcessing: false, progress: 100, outputUrl })), on(subtitleBurnerActions.setError, (state, { error }) => __spreadProps(__spreadValues({}, state), { isProcessing: false, error })), on(subtitleBurnerActions.reset, () => initialState2))
});

// src/app/modules/video/09-flip-rotate/flip-rotate.store.ts
var initialState3 = {
  file: null,
  meta: null,
  flipH: false,
...
var flipRotateActions = {
  ...
  setMeta: createAction("[FlipRotate] Set Meta", props()),
  setFlipH: createAction("[FlipRotate] Set Flip H", props()),
  setFlipV: createAction("[FlipRotate] Set Flip V", props()),
  setRotation: createAction("[FlipRotate] Set Rotation", props()),
  startProcessing: createAction("[FlipRotate] Start Processing"),
  setProgress: createAction("[FlipRotate] Set Progress", props()),
  completeProcessing: createAction("[FlipRotate] Complete Processing", props()),
  setError: createAction("[FlipRotate] Set Error", props()),
  reset: createAction("[FlipRotate] Reset")
};
var flipRotateFeature = createFeature({
  name: "flipRotate",
  reducer: createReducer(initialState3, on(flipRotateActions.loadFile, (state, { file }) => __spreadProps(__spreadValues({}, state), { file, outputUrl: null, error: null })), on(flipRotateActions.setMeta, (state, { meta }) => __spreadProps(__spreadValues({}, state), { meta })), on(flipRotateActions.setFlipH, (state, { flipH }) => __spreadProps(__spreadValues({}, state), { flipH })), on(flipRotateActions.setFlipV, (state, { flipV }) => __spreadProps(__spreadValues({}, state), { flipV })), on(flipRotateActions.setRotation, (state, { rotation }) => __spreadProps(__spreadValues({}, state), { rotation })), on(flipRotateActions.startProcessing, (state) => __spreadProps(__spreadValues({}, state), { isProcessing: true, progress: 0 })), on(flipRotateActions.setProgress, (state, { progress }) => __spreadProps(__spreadValues({}, state), { progress })), on(flipRotateActions.completeProcessing, (state, { outputUrl }) => __spreadProps(__spreadValues({}, state), { isProcessing: false, progress: 100, outputUrl })), on(flipRotateActions.setError, (state, { error }) => __spreadProps(__spreadValues({}, state), { isProcessing: false, error })), on(flipRotateActions.reset, () => initialState3))
});

// src/app/modules/video/10-crop-resize/crop-resize.store.ts
var initialState4 = {
  file: null,
  meta: null,
  crop: null,
...
var cropResizeActions = {
  ...
  setMeta: createAction("[CropResize] Set Meta", props()),
  setCrop: createAction("[CropResize] Set Crop", props()),
  setResize: createAction("[CropResize] Set Resize", props()),
  startProcessing: createAction("[CropResize] Start Processing"),
  setProgress: createAction("[CropResize] Set Progress", props()),
  completeProcessing: createAction("[CropResize] Complete Processing", props()),
  setError: createAction("[CropResize] Set Error", props()),
  reset: createAction("[CropResize] Reset")
};
var cropResizeFeature = createFeature({
  name: "cropResize",
  reducer: createReducer(initialState4, on(cropResizeActions.loadFile, (state, { file }) => __spreadProps(__spreadValues({}, state), { file, outputUrl: null, error: null })), on(cropResizeActions.setMeta, (state, { meta }) => __spreadProps(__spreadValues({}, state), { meta })), on(cropResizeActions.setCrop, (state, { crop }) => __spreadProps(__spreadValues({}, state), { crop })), on(cropResizeActions.setResize, (state, { resize }) => __spreadProps(__spreadValues({}, state), { resize })), on(cropResizeActions.startProcessing, (state) => __spreadProps(__spreadValues({}, state), { isProcessing: true, progress: 0 })), on(cropResizeActions.setProgress, (state, { progress }) => __spreadProps(__spreadValues({}, state), { progress })), on(cropResizeActions.completeProcessing, (state, { outputUrl }) => __spreadProps(__spreadValues({}, state), { isProcessing: false, progress: 100, outputUrl })), on(cropResizeActions.setError, (state, { error }) => __spreadProps(__spreadValues({}, state), { isProcessing: false, error })), on(cropResizeActions.reset, () => initialState4))
});

// src/app/modules/video/11-color-grading/color-grading.store.ts
var initialState5 = {
  file: null,
  meta: null,
  brightness: 0,
...
var colorGradingActions = {
  ...
  setMeta: createAction("[ColorGrading] Set Meta", props()),
  setBrightness: createAction("[ColorGrading] Set Brightness", props()),
  setContrast: createAction("[ColorGrading] Set Contrast", props()),
  setSaturation: createAction("[ColorGrading] Set Saturation", props()),
  setGamma: createAction("[ColorGrading] Set Gamma", props()),
  startProcessing: createAction("[ColorGrading] Start Processing"),
  setProgress: createAction("[ColorGrading] Set Progress", props()),
  completeProcessing: createAction("[ColorGrading] Complete Processing", props()),
  setError: createAction("[ColorGrading] Set Error", props()),
  reset: createAction("[ColorGrading] Reset")
};
var colorGradingFeature = createFeature({
  name: "colorGrading",
  reducer: createReducer(initialState5, on(colorGradingActions.loadFile, (state, { file }) => __spreadProps(__spreadValues({}, state), { file, outputUrl: null, error: null })), on(colorGradingActions.setMeta, (state, { meta }) => __spreadProps(__spreadValues({}, state), { meta })), on(colorGradingActions.setBrightness, (state, { brightness }) => __spreadProps(__spreadValues({}, state), { brightness })), on(colorGradingActions.setContrast, (state, { contrast }) => __spreadProps(__spreadValues({}, state), { contrast })), on(colorGradingActions.setSaturation, (state, { saturation }) => __spreadProps(__spreadValues({}, state), { saturation })), on(colorGradingActions.setGamma, (state, { gamma }) => __spreadProps(__spreadValues({}, state), { gamma })), on(colorGradingActions.startProcessing, (state) => __spreadProps(__spreadValues({}, state), { isProcessing: true, progress: 0 })), on(colorGradingActions.setProgress, (state, { progress }) => __spreadProps(__spreadValues({}, state), { progress })), on(colorGradingActions.completeProcessing, (state, { outputUrl }) => __spreadProps(__spreadValues({}, state), { isProcessing: false, progress: 100, outputUrl })), on(colorGradingActions.setError, (state, { error }) => __spreadProps(__spreadValues({}, state), { isProcessing: false, error })), on(colorGradingActions.reset, () => initialState5))
});
...
var appConfig = {
  providers: [
    ...
    provideStore(__spreadProps(__spreadValues({}, reducers), {
