...
var SplitterComponent = class _SplitterComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-5FXYQRER.js", import.meta.url), { type: "module" }), { file: state.inputFile, splitMode: this.splitMode, segmentCount: this.segmentCount, segmentDuration: this.segmentDuration, duration: state.videoMeta?.duration ?? 0 }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-WD2IISSI.mjs.map
