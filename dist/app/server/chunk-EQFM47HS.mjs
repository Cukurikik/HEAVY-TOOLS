...
// src/app/modules/converter/15-currency-converter/currency-converter.component.ts
function CurrencyConverterComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 13);
    \u0275\u0275text(1, " Processing... ");
  }
}
function CurrencyConverterComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u{1F4B1} Convert ");
  }
}
function CurrencyConverterComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function CurrencyConverterComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
...
function CurrencyConverterComponent_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CurrencyConverterComponent_Conditional_24_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
var OUTPUT_FORMATS = [
  { value: "USD", label: "USD", icon: "\u{1F4C4}" },
  { value: "EUR", label: "EUR", icon: "\u{1F4C4}" },
  { value: "GBP", label: "GBP", icon: "\u{1F4C4}" },
  { value: "JPY", label: "JPY", icon: "\u{1F4C4}" },
  { value: "CNY", label: "CNY", icon: "\u{1F4C4}" },
  { value: "KRW", label: "KRW", icon: "\u{1F4C4}" },
  { value: "IDR", label: "IDR", icon: "\u{1F4C4}" }
];
var CurrencyConverterComponent = class _CurrencyConverterComponent {
  store = inject(Store);
  ...
  static \u0275fac = function CurrencyConverterComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CurrencyConverterComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CurrencyConverterComponent, selectors: [["app-currency-converter"]], decls: 26, vars: 19, consts: [[1, "min-h-screen", "bg-[#0a0a0f]", "p-6", "space-y-6"], [1, "space-y-1"], [1, "text-3xl", "font-bold", "text-transparent", "bg-clip-text", "bg-gradient-to-r", "from-cyan-400", "to-purple-400"], [1, "text-white/50", "text-sm"], [1, "grid", "grid-cols-1", "lg:grid-cols-2", "gap-6"], [1, "space-y-4"], [1, "p-4", "rounded-2xl", "bg-white/5", "border", "border-white/10", "space-y-3"], [1, "text-xs", "text-white/40", "uppercase", "tracking-wider", "font-semibold"], ["rows", "6", "placeholder", "Enter value to convert...", 1, "w-full", "px-3", "py-2", "text-sm", "bg-white/5", "border", "border-white/15", "rounded-xl", "text-white", "placeholder-white/20", "focus:outline-none", "focus:border-cyan-400", "resize-none", "font-mono", 3, "input"], [3, "formatChange", "formats", "selected"], [1, "w-full", "py-3", "rounded-xl", "font-semibold", "text-sm", "transition-all", "duration-300", "flex", "items-center", "justify-center", "gap-2", "bg-gradient-to-r", "from-cyan-500", "to-blue-500", "text-black", "disabled:opacity-40", "disabled:cursor-not-allowed", 3, "click", "disabled"], [1, "p-3", "rounded-xl", "bg-red-500/10", "border", "border-red-500/30", "text-sm", "text-red-400"], [1, "flex", "justify-center", "p-8"], [1, "w-4", "h-4", "border-2", "border-current", "border-t-transparent", "rounded-full", "animate-spin"], ["label", "Converting...", 3, "progress"], [1, "flex", "items-center", "justify-between"], [1, "text-xs", "text-cyan-400", "hover:text-cyan-300", 3, "click"], [1, "text-sm", "text-white/80", "font-mono", "whitespace-pre-wrap", "break-all", "bg-white/5", "p-3", "rounded-lg", "max-h-64", "overflow-auto"]], template: function CurrencyConverterComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "header", 1)(2, "h1", 2);
      \u0275\u0275text(3, " \u{1F4B1} Currency Converter ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "p", 3);
      \u0275\u0275text(5, "Convert between 160+ world currencies with live exchange rates");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "div", 4)(7, "div", 5)(8, "div", 6)(9, "label", 7);
      \u0275\u0275text(10, "Input");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(11, "textarea", 8);
      \u0275\u0275listener("input", function CurrencyConverterComponent_Template_textarea_input_11_listener($event) {
        return ctx.onInputChange($event.target.value);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(12, "app-converter-format-selector", 9);
      \u0275\u0275pipe(13, "async");
      \u0275\u0275listener("formatChange", function CurrencyConverterComponent_Template_app_converter_format_selector_formatChange_12_listener($event) {
        return ctx.onFormatChange($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "button", 10);
      \u0275\u0275pipe(15, "async");
      \u0275\u0275listener("click", function CurrencyConverterComponent_Template_button_click_14_listener() {
        return ctx.onProcess();
      });
      \u0275\u0275conditionalCreate(16, CurrencyConverterComponent_Conditional_16_Template, 2, 0);
      \u0275\u0275pipe(17, "async");
      \u0275\u0275conditionalBranchCreate(18, CurrencyConverterComponent_Conditional_18_Template, 1, 0);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(19, CurrencyConverterComponent_Conditional_19_Template, 3, 3, "div", 11);
      \u0275\u0275pipe(20, "async");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "div", 5);
      \u0275\u0275conditionalCreate(22, CurrencyConverterComponent_Conditional_22_Template, 3, 3, "div", 12);
      \u0275\u0275pipe(23, "async");
      \u0275\u0275conditionalCreate(24, CurrencyConverterComponent_Conditional_24_Template, 9, 3, "div", 6);
      \u0275\u0275pipe(25, "async");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      ...
      let tmp_6_0;
      \u0275\u0275advance(12);
      \u0275\u0275property("formats", ctx.outputFormats)("selected", ((tmp_1_0 = \u0275\u0275pipeBind1(13, 7, ctx.state$)) == null ? null : tmp_1_0.outputFormat) ?? "USD");
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CurrencyConverterComponent, [{
    type: Component,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CurrencyConverterComponent, { className: "CurrencyConverterComponent", filePath: "src/app/modules/converter/15-currency-converter/currency-converter.component.ts", lineNumber: 91 });
})();
export {
  CurrencyConverterComponent
};
//# sourceMappingURL=chunk-EQFM47HS.mjs.map
