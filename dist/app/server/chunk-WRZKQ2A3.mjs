...
var VideoToGifComponent = class _VideoToGifComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-HMDBGIA6.js", import.meta.url), { type: "module" }), { file: state.inputFile, fps: this.fps, scale: this.scale }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-WRZKQ2A3.mjs.map
