...
var StabilizerComponent = class _StabilizerComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-FEGK6LIB.js", import.meta.url), { type: "module" }), { file: state.inputFile, shakiness: state.shakiness, smoothing: state.smoothing, cropMode: state.cropMode }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-H4KD2YFI.mjs.map
