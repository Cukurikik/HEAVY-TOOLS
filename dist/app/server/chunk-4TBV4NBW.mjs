...
var ReverserComponent = class _ReverserComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-QUAJKES6.js", import.meta.url), { type: "module" }), { file: state.inputFile, audioMode: this.selectedAudioMode, speed: this.selectedSpeed }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-4TBV4NBW.mjs.map
