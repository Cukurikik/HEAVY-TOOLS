...
// src/app/modules/converter/19-font-converter/font-converter.component.ts
function FontConverterComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 12);
    \u0275\u0275text(1, " Processing... ");
  }
}
function FontConverterComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u{1F524} Convert ");
  }
}
function FontConverterComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
...
function FontConverterComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function FontConverterComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
...
var OUTPUT_FORMATS = [
  { value: "ttf", label: "TTF", icon: "\u{1F4C4}" },
  { value: "otf", label: "OTF", icon: "\u{1F4C4}" },
  { value: "woff", label: "WOFF", icon: "\u{1F4C4}" },
  { value: "woff2", label: "WOFF2", icon: "\u{1F4C4}" },
  { value: "eot", label: "EOT", icon: "\u{1F4C4}" }
];
var FontConverterComponent = class _FontConverterComponent {
  store = inject(Store);
  state$ = this.store.select(selectFontConverterState);
  outputFormats = OUTPUT_FORMATS;
  onFilesSelected(files) {
    this.store.dispatch(FontConverterActions.loadFile({ file: files[0] }));
  }
  onFormatChange(format) {
    this.store.dispatch(FontConverterActions.setOutputFormat({ format }));
  }
  onProcess() {
    this.store.dispatch(FontConverterActions.startProcessing());
  }
  ngOnDestroy() {
    this.store.dispatch(FontConverterActions.resetState());
  }
  static \u0275fac = function FontConverterComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _FontConverterComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FontConverterComponent, selectors: [["app-font-converter"]], decls: 23, vars: 21, consts: [[1, "min-h-screen", "bg-[#0a0a0f]", "p-6", "space-y-6"], [1, "space-y-1"], [1, "text-3xl", "font-bold", "text-transparent", "bg-clip-text", "bg-gradient-to-r", "from-cyan-400", "to-purple-400"], [1, "text-white/50", "text-sm"], [1, "grid", "grid-cols-1", "lg:grid-cols-2", "gap-6"], [1, "space-y-4"], ["accept", ".ttf,.otf,.woff,.woff2,.eot", "label", "Drop file here or click to browse", 3, "filesSelected", "multiple", "maxSizeMB"], [3, "formatChange", "formats", "selected"], [1, "w-full", "py-3", "rounded-xl", "font-semibold", "text-sm", "transition-all", "duration-300", "flex", "items-center", "justify-center", "gap-2", "bg-gradient-to-r", "from-cyan-500", "to-blue-500", "text-black", "disabled:opacity-40", "disabled:cursor-not-allowed", 3, "click", "disabled"], [1, "p-3", "rounded-xl", "bg-red-500/10", "border", "border-red-500/30", "text-sm", "text-red-400"], [1, "flex", "justify-center", "p-8"], ["filename", "exia_font_converter", 3, "outputBlob", "outputSizeMB"], [1, "w-4", "h-4", "border-2", "border-current", "border-t-transparent", "rounded-full", "animate-spin"], ["label", "Converting...", 3, "progress"]], template: function FontConverterComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "header", 1)(2, "h1", 2);
      \u0275\u0275text(3, " \u{1F524} Font Converter ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "p", 3);
      \u0275\u0275text(5, "Convert fonts between TTF, OTF, WOFF, WOFF2, EOT formats");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "div", 4)(7, "div", 5)(8, "app-converter-file-drop-zone", 6);
      \u0275\u0275listener("filesSelected", function FontConverterComponent_Template_app_converter_file_drop_zone_filesSelected_8_listener($event) {
        return ctx.onFilesSelected($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "app-converter-format-selector", 7);
      \u0275\u0275pipe(10, "async");
      \u0275\u0275listener("formatChange", function FontConverterComponent_Template_app_converter_format_selector_formatChange_9_listener($event) {
        return ctx.onFormatChange($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(11, "button", 8);
      \u0275\u0275pipe(12, "async");
      \u0275\u0275listener("click", function FontConverterComponent_Template_button_click_11_listener() {
        return ctx.onProcess();
      });
      \u0275\u0275conditionalCreate(13, FontConverterComponent_Conditional_13_Template, 2, 0);
      \u0275\u0275pipe(14, "async");
      \u0275\u0275conditionalBranchCreate(15, FontConverterComponent_Conditional_15_Template, 1, 0);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(16, FontConverterComponent_Conditional_16_Template, 3, 3, "div", 9);
      \u0275\u0275pipe(17, "async");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "div", 5);
      \u0275\u0275conditionalCreate(19, FontConverterComponent_Conditional_19_Template, 3, 3, "div", 10);
      \u0275\u0275pipe(20, "async");
      \u0275\u0275conditionalCreate(21, FontConverterComponent_Conditional_21_Template, 3, 6, "app-converter-export-panel", 11);
      \u0275\u0275pipe(22, "async");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      ...
      let tmp_8_0;
      \u0275\u0275advance(8);
      \u0275\u0275property("multiple", false)("maxSizeMB", 20);
      \u0275\u0275advance();
      \u0275\u0275property("formats", ctx.outputFormats)("selected", ((tmp_3_0 = \u0275\u0275pipeBind1(10, 9, ctx.state$)) == null ? null : tmp_3_0.outputFormat) ?? "ttf");
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FontConverterComponent, [{
    type: Component,
    args: [{
    ...
    <div class="min-h-screen bg-[#0a0a0f] p-6 space-y-6">
      <header class="space-y-1">
        <h1 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">
          \u{1F524} Font Converter
        </h1>
        <p class="text-white/50 text-sm">Convert fonts between TTF, OTF, WOFF, WOFF2, EOT formats</p>
      </header>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="space-y-4">
          ...
          <app-converter-format-selector
            ...
            [selected]="(state$ | async)?.outputFormat ?? 'ttf'"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FontConverterComponent, { className: "FontConverterComponent", filePath: "src/app/modules/converter/19-font-converter/font-converter.component.ts", lineNumber: 85 });
})();
export {
  FontConverterComponent
};
//# sourceMappingURL=chunk-3G3YC2VH.mjs.map
