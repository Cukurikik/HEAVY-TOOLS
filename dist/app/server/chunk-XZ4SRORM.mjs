...
var LooperComponent = class _LooperComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-2EXZM2PW.js", import.meta.url), { type: "module" }), { file: state.inputFile, loopCount: this.loopCount, transitionMode: this.selectedTransition }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-XZ4SRORM.mjs.map
