...
// src/app/modules/converter/25-qr-generator/qr-generator.component.ts
function QrGeneratorComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 13);
    \u0275\u0275text(1, " Processing... ");
  }
}
function QrGeneratorComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u{1F4F1} Convert ");
  }
}
function QrGeneratorComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function QrGeneratorComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
...
function QrGeneratorComponent_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function QrGeneratorComponent_Conditional_24_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
var QrGeneratorComponent = class _QrGeneratorComponent {
  ...
  onInputChange(value) {
    this.store.dispatch(QrGeneratorActions.setInputText({ text: value }));
  }
  onCopy() {
    this.store.dispatch(QrGeneratorActions.copyToClipboard());
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(QrGeneratorComponent, { className: "QrGeneratorComponent", filePath: "src/app/modules/converter/25-qr-generator/qr-generator.component.ts", lineNumber: 87 });
})();
export {
  QrGeneratorComponent
};
//# sourceMappingURL=chunk-Q2IOOHSZ.mjs.map
