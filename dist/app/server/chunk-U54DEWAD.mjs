...
var DenoiserComponent = class _DenoiserComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-EIA3A62I.js", import.meta.url), { type: "module" }), { file: state.inputFile, algorithm: this.algorithm, strength: this.strength, temporal: this.temporal }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-U54DEWAD.mjs.map
