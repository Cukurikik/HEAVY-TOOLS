...
var BlurComponent = class _BlurComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-U4LEDJK5.js", import.meta.url), { type: "module" }), { file: state.inputFile, blurType: this.blurType, strength: this.blurStrength, region: this.region }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-M2LFLFBQ.mjs.map
