...
var WatermarkComponent = class _WatermarkComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-MRGOXWVF.js", import.meta.url), { type: "module" }), { file: state.inputFile, mode: this.wmMode, text: this.wmText, fontSize: this.wmFontSize, imageFile: this.wmImage, position: this.wmPosition, opacity: this.wmOpacity / 100 }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-ORNHVVO4.mjs.map
