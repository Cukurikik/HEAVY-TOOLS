...
var CropResizeComponent = class _CropResizeComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-PV4I44HM.js", import.meta.url), { type: "module" }), { file: state.inputFile, mode: "resize", targetWidth: this.targetWidth, targetHeight: this.targetHeight, padMode: this.padMode }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-S72QAYQ3.mjs.map
