...
var FFmpegService = class _FFmpegService {
  ...
  async _doLoad() {
    try {
      ...
      const { FFmpeg } = await import("./chunk-NS6M3UR2.mjs");
      const { toBlobURL } = await import("./chunk-VZTZ2R26.mjs");
      const ff = new FFmpeg();
  ...
  async getMetadata(file) {
    ...
    const { fetchFile } = await import("./chunk-VZTZ2R26.mjs");
...
//# sourceMappingURL=chunk-KDRYMVOJ.mjs.map
