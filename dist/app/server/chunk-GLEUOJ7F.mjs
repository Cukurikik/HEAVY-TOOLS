...
var CompressorComponent = class _CompressorComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-6VAMY5LS.js", import.meta.url), { type: "module" }), { file: state.inputFile, crfValue: state.crfValue, outputFormat: "mp4" }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-GLEUOJ7F.mjs.map
