...
var AnalyserComponent = class _AnalyserComponent {
  ...
  onDeepAnalyse() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-XXAHNJKA.js", import.meta.url), { type: "module" }), { file: state.inputFile, mode: "probe" }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-ZIRHOZ5S.mjs.map
