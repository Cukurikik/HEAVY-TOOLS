...
var MergerComponent = class _MergerComponent {
  ...
  onProcess() {
    ...
    this.bridge.process(() => new Worker(new URL("worker-LHNH3AFO.js", import.meta.url), { type: "module" }), { clips: this.clips.map((f) => ({ file: f })), outputFormat: "mp4" }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-JUIEUX4F.mjs.map
