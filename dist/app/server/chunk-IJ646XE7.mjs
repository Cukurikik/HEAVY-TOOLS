...
var ThumbnailGeneratorComponent = class _ThumbnailGeneratorComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-RYW2QDIO.js", import.meta.url), { type: "module" }), { file: state.inputFile, mode: this.mode, interval: this.interval }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-IJ646XE7.mjs.map
