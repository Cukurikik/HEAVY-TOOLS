...
var ColorGradingComponent = class _ColorGradingComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-RBL4FQ4F.js", import.meta.url), { type: "module" }), { file: state.inputFile, brightness: this.brightness, contrast: this.contrast, saturation: this.saturation, gamma: this.gamma }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-4SCHT43C.mjs.map
