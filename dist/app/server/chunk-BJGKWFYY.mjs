  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile || !this.subtitleFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-674OCDAK.js", import.meta.url), { type: "module" }), { file: state.inputFile, subtitleFile: this.subtitleFile, fontSize: this.fontSize, position: this.position, fontColor: this.fontColor }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-BJGKWFYY.mjs.map
