...
var AudioExtractorComponent = class _AudioExtractorComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-K537KXCM.js", import.meta.url), { type: "module" }), { file: state.inputFile, outputFormat: this.outputFormat }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-XVJRPYWO.mjs.map
