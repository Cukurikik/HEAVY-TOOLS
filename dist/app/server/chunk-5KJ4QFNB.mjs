...
var ConverterComponent = class _ConverterComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-HXKY6WDV.js", import.meta.url), { type: "module" }), { file: state.inputFile, targetFormat: state.targetFormat, qualityPreset: state.qualityPreset }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-5KJ4QFNB.mjs.map
