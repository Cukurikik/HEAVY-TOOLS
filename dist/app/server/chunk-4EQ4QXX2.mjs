  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile || !state.videoMeta)
        return;
      this.bridge.process(() => new Worker(new URL("worker-RDMTXRQQ.js", import.meta.url), { type: "module" }), { file: state.inputFile, startTime: state.startTime, endTime: state.endTime, outputFormat: state.outputFormat }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-4EQ4QXX2.mjs.map
