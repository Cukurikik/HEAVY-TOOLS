...
var TransitionsComponent = class _TransitionsComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-VSRSCSMT.js", import.meta.url), { type: "module" }), { file: state.inputFile, transition: this.transition, duration: this.transitionDuration }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-T2VFGSMP.mjs.map
