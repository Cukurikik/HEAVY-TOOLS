...
var FlipRotateComponent = class _FlipRotateComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-RUT5PPXN.js", import.meta.url), { type: "module" }), { file: state.inputFile, flipH: this.flipH, flipV: this.flipV, rotation: this.rotation }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-IKT4OLNP.mjs.map
