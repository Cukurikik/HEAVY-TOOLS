...
// src/app/modules/converter/12-html-converter/html-converter.component.ts
function HtmlConverterComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 12);
    \u0275\u0275text(1, " Processing... ");
  }
}
function HtmlConverterComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u{1F310} Convert ");
  }
}
function HtmlConverterComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
...
function HtmlConverterComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function HtmlConverterComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
...
var HtmlConverterComponent = class _HtmlConverterComponent {
  store = inject(Store);
  ...
  static \u0275fac = function HtmlConverterComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _HtmlConverterComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HtmlConverterComponent, selectors: [["app-html-converter"]], decls: 23, vars: 21, consts: [[1, "min-h-screen", "bg-[#0a0a0f]", "p-6", "space-y-6"], [1, "space-y-1"], [1, "text-3xl", "font-bold", "text-transparent", "bg-clip-text", "bg-gradient-to-r", "from-cyan-400", "to-purple-400"], [1, "text-white/50", "text-sm"], [1, "grid", "grid-cols-1", "lg:grid-cols-2", "gap-6"], [1, "space-y-4"], ["accept", ".html,.htm,.txt", "label", "Drop file here or click to browse", 3, "filesSelected", "multiple", "maxSizeMB"], [3, "formatChange", "formats", "selected"], [1, "w-full", "py-3", "rounded-xl", "font-semibold", "text-sm", "transition-all", "duration-300", "flex", "items-center", "justify-center", "gap-2", "bg-gradient-to-r", "from-cyan-500", "to-blue-500", "text-black", "disabled:opacity-40", "disabled:cursor-not-allowed", 3, "click", "disabled"], [1, "p-3", "rounded-xl", "bg-red-500/10", "border", "border-red-500/30", "text-sm", "text-red-400"], [1, "flex", "justify-center", "p-8"], ["filename", "exia_html_converter", 3, "outputBlob", "outputSizeMB"], [1, "w-4", "h-4", "border-2", "border-current", "border-t-transparent", "rounded-full", "animate-spin"], ["label", "Converting...", 3, "progress"]], template: function HtmlConverterComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "header", 1)(2, "h1", 2);
      \u0275\u0275text(3, " \u{1F310} HTML Converter ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "p", 3);
      \u0275\u0275text(5, "Convert HTML to PDF, Markdown, plain text, or DOCX");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "div", 4)(7, "div", 5)(8, "app-converter-file-drop-zone", 6);
      \u0275\u0275listener("filesSelected", function HtmlConverterComponent_Template_app_converter_file_drop_zone_filesSelected_8_listener($event) {
        return ctx.onFilesSelected($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "app-converter-format-selector", 7);
      \u0275\u0275pipe(10, "async");
      \u0275\u0275listener("formatChange", function HtmlConverterComponent_Template_app_converter_format_selector_formatChange_9_listener($event) {
        return ctx.onFormatChange($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(11, "button", 8);
      \u0275\u0275pipe(12, "async");
      \u0275\u0275listener("click", function HtmlConverterComponent_Template_button_click_11_listener() {
        return ctx.onProcess();
      });
      \u0275\u0275conditionalCreate(13, HtmlConverterComponent_Conditional_13_Template, 2, 0);
      \u0275\u0275pipe(14, "async");
      \u0275\u0275conditionalBranchCreate(15, HtmlConverterComponent_Conditional_15_Template, 1, 0);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(16, HtmlConverterComponent_Conditional_16_Template, 3, 3, "div", 9);
      \u0275\u0275pipe(17, "async");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "div", 5);
      \u0275\u0275conditionalCreate(19, HtmlConverterComponent_Conditional_19_Template, 3, 3, "div", 10);
      \u0275\u0275pipe(20, "async");
      \u0275\u0275conditionalCreate(21, HtmlConverterComponent_Conditional_21_Template, 3, 6, "app-converter-export-panel", 11);
      \u0275\u0275pipe(22, "async");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("formats", ctx.outputFormats)("selected", ((tmp_3_0 = \u0275\u0275pipeBind1(10, 9, ctx.state$)) == null ? null : tmp_3_0.outputFormat) ?? "pdf");
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HtmlConverterComponent, [{
    type: Component,
    args: [{
    ...
    <div class="min-h-screen bg-[#0a0a0f] p-6 space-y-6">
      <header class="space-y-1">
        <h1 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">
          \u{1F310} HTML Converter
        </h1>
        <p class="text-white/50 text-sm">Convert HTML to PDF, Markdown, plain text, or DOCX</p>
      </header>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HtmlConverterComponent, { className: "HtmlConverterComponent", filePath: "src/app/modules/converter/12-html-converter/html-converter.component.ts", lineNumber: 85 });
})();
export {
  HtmlConverterComponent
};
//# sourceMappingURL=chunk-KOT5FRH2.mjs.map
