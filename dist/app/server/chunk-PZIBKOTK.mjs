  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile || !this.secondVideo)
        return;
      this.bridge.process(() => new Worker(new URL("worker-D5HWAEWP.js", import.meta.url), { type: "module" }), { file: state.inputFile, secondFile: this.secondVideo, layout: this.layout }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-PZIBKOTK.mjs.map
