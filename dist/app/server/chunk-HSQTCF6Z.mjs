  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile || !this.overlayFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-YLEGZYHX.js", import.meta.url), { type: "module" }), { file: state.inputFile, overlayFile: this.overlayFile, position: this.pipPosition, scale: this.pipScale }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-HSQTCF6Z.mjs.map
