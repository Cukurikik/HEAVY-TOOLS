...
var UpscalerComponent = class _UpscalerComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-BZRP5U3V.js", import.meta.url), { type: "module" }), { file: state.inputFile, scale: this.scaleFactor, model: this.model, denoise: this.denoiseLevel }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-LXY5Z5UN.mjs.map
