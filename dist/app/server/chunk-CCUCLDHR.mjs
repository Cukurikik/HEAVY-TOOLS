...
var CropResizeComponent = class _CropResizeComponent {
  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-FGUKXNWL.js", import.meta.url), { type: "module" }), { file: state.inputFile }).subscribe({
        next: (msg) => {
...
//# sourceMappingURL=chunk-CCUCLDHR.mjs.map
