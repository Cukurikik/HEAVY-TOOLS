  ...
  onProcess() {
    ...
    this.state$.subscribe((state) => {
      if (!state.inputFile || !this.audioFile)
        return;
      this.bridge.process(() => new Worker(new URL("worker-SVXYJTP5.js", import.meta.url), { type: "module" }), { file: state.inputFile, audioFile: this.audioFile, mixMode: this.mixMode, origVolume: this.origVolume / 100, newVolume: this.newVolume / 100 }).subscribe((msg) => {
...
//# sourceMappingURL=chunk-A5PCKNXX.mjs.map
