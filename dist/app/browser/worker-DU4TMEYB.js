...
// src/app/modules/video/13-thumbnail-generator/thumbnailGenerator.worker.ts
var ffmpeg = null;
...
addEventListener("message", async (e) => {
  ...
  try {
    ...
    if (mode === "grid") {
      ...
      done(new Blob([new Uint8Array(data)], { type: "image/png" }));
...
//# sourceMappingURL=worker-DU4TMEYB.js.map
