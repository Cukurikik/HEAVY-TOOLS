...
// src/app/modules/video/24-blur/blur.worker.ts
var ffmpeg = null;
...
addEventListener("message", async (e) => {
  ...
  try {
    ...
    const { file, strength = 5 } = config;
    const inName = "in.mp4";
    const outName = "blur.mp4";
    ffmpeg.writeFile(inName, await fetchFile(file));
    const vf = `boxblur=${strength}:1`;
...
//# sourceMappingURL=worker-U4LEDJK5.js.map
