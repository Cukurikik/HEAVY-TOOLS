...
// src/app/modules/video/09-watermark/watermark.worker.ts
var ffmpeg = null;
...
addEventListener("message", async (e) => {
  ...
  try {
    ...
    await ffmpeg.exec([
      ...
      watermarkName,
      "-filter_complex",
      `[1:v]format=rgba,colorchannelmixer=aa=${config.opacity}[wm];[0:v][wm]overlay=${overlayFilter}`,
      "-c:a",
      "copy",
      outputName
    ]);
...
//# sourceMappingURL=worker-ZJLRI764.js.map
