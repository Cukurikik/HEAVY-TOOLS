...
// src/app/modules/video/13-audio-extractor/audio-extractor.worker.ts
var ffmpeg = null;
...
addEventListener("message", async (e) => {
  ...
  try {
    ...
    await ffmpeg.exec([
      ...
      "-vn",
      "-acodec",
      config.format === "mp3" ? "libmp3lame" : config.format === "wav" ? "pcm_s16le" : "aac",
      outputName
    ]);
...
//# sourceMappingURL=worker-56EPIFFS.js.map
