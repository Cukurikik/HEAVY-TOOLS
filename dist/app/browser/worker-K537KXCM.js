...
// src/app/modules/video/15-audio-extractor/audioExtractor.worker.ts
var ffmpeg = null;
...
addEventListener("message", async (e) => {
  ...
  try {
    ...
    done(new Blob([new Uint8Array(data)], { type: mimeMap[outputFormat] || "audio/mpeg" }));
...
//# sourceMappingURL=worker-K537KXCM.js.map
