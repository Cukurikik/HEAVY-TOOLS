...
// src/app/modules/video/18-interpolator/interpolator.worker.ts
var ffmpeg = null;
...
addEventListener("message", async (e) => {
  ...
  try {
    ...
    const { file, targetFps = 60 } = config;
    const inName = "in.mp4";
    const outName = "interpolated.mp4";
    ffmpeg.writeFile(inName, await fetchFile(file));
    const vf = `fps=${targetFps}`;
...
//# sourceMappingURL=worker-BBLSHRQP.js.map
