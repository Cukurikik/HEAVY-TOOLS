...
// src/app/modules/video/20-splitter/splitter.worker.ts
var ffmpeg = null;
...
addEventListener("message", async (e) => {
  ...
  try {
    ...
    const { file, numParts = 2 } = config;
    const inName = "in." + (file.name.split(".").pop() || "mp4");
    ffmpeg.writeFile(inName, await fetchFile(file));
    const outName = "part1.mp4";
    await ffmpeg.exec(["-i", inName, "-t", "10", "-c", "copy", outName]);
...
//# sourceMappingURL=worker-7N6U34NZ.js.map
