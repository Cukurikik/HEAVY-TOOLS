...
// src/app/modules/video/04-compressor/compressor.worker.ts
var ffmpeg = null;
...
addEventListener("message", async (e) => {
  ...
  try {
    ...
    const { file, crfValue = 28, outputFormat = "mp4" } = config;
    ...
    done(new Blob([new Uint8Array(data)], { type: "video/" + outputFormat }));
...
//# sourceMappingURL=worker-6VAMY5LS.js.map
